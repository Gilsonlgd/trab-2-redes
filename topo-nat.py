...
class BasicTopo(Topo):
    def build(self, **_opts):
        ...
        server1 = self.addHost('server1', ip='8.8.8.8/16', defaultRoute='via 8.8.254.254') #TCP
        server2 = self.addHost('server2', ip='8.8.4.4/16', defaultRoute='via 8.8.254.254') #UDP
